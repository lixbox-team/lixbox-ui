 ...
 * @author ludovic.terral
 */
@FacesComponent(createTag = true, tagName = "body", namespace = "http://www.lixbox.fr/modal")
public class ModalBodyComponent extends UIComponentBase implements LixboxComponent
{    
    // ----------- Attribut(s) -----------
    ...
    public ModalBodyComponent() 
    {
        ...
        {
            case "bootstrap":
                setRendererType("lixbox.component.modal.bootstrap.ModalBodyComponent");
                break;
            default:
                setRendererType("lixbox.component.modal.bootstrap.ModalBodyComponent");
                break;
