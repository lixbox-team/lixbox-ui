 ...
 * @author ludovic.terral
 */
@FacesComponent(createTag = true, tagName = "footer", namespace = "http://www.lixbox.fr/layout")
public class FooterComponent extends UIComponentBase implements LixboxComponent
{    
    // ----------- Attribut(s) -----------
    ...
    public FooterComponent() 
    {
        ...
        {
            case "bootstrap":
                setRendererType("lixbox.component.layout.bootstrap.FooterComponent");
                break;
            default:
                setRendererType("lixbox.component.layout.bootstrap.FooterComponent");
                break;
